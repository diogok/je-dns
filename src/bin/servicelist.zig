...
pub fn main() !void {
    ...
    var iter1 = try dns.queryMDNS("_spotify-connect._tcp.local", dns.mdns_services_resource_type, .{});
    defer iter1.deinit();
    ...
    var iter2 = try dns.queryMDNS("_hello._tcp.local", dns.mdns_services_resource_type, .{});
    defer iter2.deinit();
